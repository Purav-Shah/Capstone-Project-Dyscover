  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex items-center justify-center min-h-[calc(100vh-200px)] px-6">
        ...
        >
          <div
            className={`backdrop-blur-lg rounded-3xl p-8 shadow-2xl border transition-all duration-500 max-w-2xl text-center ${
          ...
          >
            ...
            <p className={`text-lg mb-8 ${isDarkMode ? "text-slate-300" : "text-slate-700"}`}>
              {(() => {
                const a = Number(age)
                return a >= 3 && a <= 5 ? "Continue to the results." : "Continue to the audio reading test."
              })()}
            </p>
            <button
      ...
      <footer className="relative z-10 p-6 lg:p-8">
        <div
          className={`flex items-center justify-center transition-all duration-1000 delay-500 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
        >
