...
export default function NonsenseRouterPage() {
  ...
  useEffect(() => {
    ...
    else if (group === "6-8") router.replace(`/nonsense/mid?${params.toString()}`)
  }, [group, params, router])
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex items-center justify-center min-h-[calc(100vh-120px)] px-6">
        ...
        >
          <div
            className={`backdrop-blur-lg rounded-3xl p-12 shadow-2xl border transition-all duration-500 text-center ${
          ...
          >
            <h1 className={`text-3xl font-bold mb-4 ${isDarkMode ? "text-white" : "text-slate-900"}`}>
              Loading Nonsense Words Assessment...
            </h1>
