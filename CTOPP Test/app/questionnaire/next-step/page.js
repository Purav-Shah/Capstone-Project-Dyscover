...
export default function QuestionnaireNextStepPage() {
  ...
  const handleContinue = () => {
    const qp = new URLSearchParams(searchParams.toString()).toString()
    router.push(`/pretest?${qp}`)
  }
      ...
      <div className="relative z-10 flex items-center justify-center min-h-[calc(100vh-120px)] px-6">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className={isDarkMode ? "text-slate-300" : "text-slate-600"}>Thank you for completing the assessment.</p>
          </div>
